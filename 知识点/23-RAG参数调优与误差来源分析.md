...
- [examples/rag_tuning_intro.py](/mnt/d/AIcodes/Agent/examples/rag_tuning_intro.py)
...
我们在 [examples/rag_tuning_intro.py](/mnt/d/AIcodes/Agent/examples/rag_tuning_intro.py) 中准备了多组实验：
...
文件：[examples/rag_tuning_intro.py](/mnt/d/AIcodes/Agent/examples/rag_tuning_intro.py)
...
```bash
python examples/rag_tuning_intro.py
```
